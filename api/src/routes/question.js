...
const router = Router();
const { createQuestion, getQuestions, getQuestion, updateQuestion, deleteQuestion, likeQuestion, unlikeQuestion, viewQuestion, logDelete, rateQuestion } = require('../controllers/questionsController.js')
