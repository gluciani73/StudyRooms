...
export default function CreateUser() {
    ...
    return (
        <form onSubmit={(e) => handleSubmit(e)} className="d-flex flex-wrap justify-content-center bg-white p-3 container rounded">
            ...
            <div className='d-block pt-5'>
                <div className='justify-content-center text-center'>
                    ...
                    <button type='submit'
                        value='Register'
                        className="btn btn-dark m-2">Registrarse</button>
                    <button type="button"
                        onClick={(e) => handleRegister(e)}
                        className="btn btn-dark m-2">Volver</button>
